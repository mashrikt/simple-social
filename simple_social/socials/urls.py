...
posts_patterns = [
    ...
    path('<post_id>/reactions/', ReactionListCreateView.as_view(), name='reaction-list-create'),
    path('<post_id>/reactions/<pk>/', ReactionRetrieveUpdateDestroyView.as_view(), name='reaction-list-create'),
]
